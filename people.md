...
|Name          |Type      |Description
|-----------    |-----------|--------------
|party.identification|flexenum    |One of "None", "Democratic", "Republican", "Independent", or another free-form string.
|party.last_verified_date  |integer    |A value representing the last verified date of the party registration.
|party.status|boolean     |Whether or not this party registration is active for the affiliated person.
